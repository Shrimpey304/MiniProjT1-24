...
public static class World
{
    ...
    public static void PopulateLocations()
    {
        ...
        home.optionsAndActions.Add(QuitGame());
        ...
        townSquare.optionsAndActions.Add(QuitGame());
        ...
        alchemistHut.optionsAndActions.Add(QuitGame());
        ...
        alchemistsGarden.optionsAndActions.Add(QuitGame());
        ...
        farmhouse.optionsAndActions.Add(QuitGame());
        ...
        farmersField.optionsAndActions.Add(QuitGame());
        ...
        guardPost.optionsAndActions.Add(QuitGame());
        ...
        bridge.optionsAndActions.Add(QuitGame());
        ...
        spiderField.optionsAndActions.Add(QuitGame());
